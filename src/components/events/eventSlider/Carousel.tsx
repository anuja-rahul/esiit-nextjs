...
const Carousel = () => {
  ...
  return (
    ...
    >
      ...
      {/* <!--Carousel items--> */}
      <div className="relative top-10 w-full overflow-hidden after:clear-both after:block after:content-['']">
        {/* <!--First item--> */}
        <div
        ...
        >
          <img src={eventBanners[0].img} className="block w-full" alt="..." />
          {/* <div className="absolute inset-x-[15%] bottom-10 hidden py-5 text-center text-white md:block">
